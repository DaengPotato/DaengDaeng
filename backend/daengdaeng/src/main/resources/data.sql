delete from mbti;
insert into mbti(mbti_id, mbti) values(1, 'ESOW');
insert into mbti(mbti_id, mbti) values(2, 'ESOD');
insert into mbti(mbti_id, mbti) values(3, 'ESHW');
insert into mbti(mbti_id, mbti) values(4, 'ESHD');
insert into mbti(mbti_id, mbti) values(5, 'ENOW');
insert into mbti(mbti_id, mbti) values(6, 'ENOD');
insert into mbti(mbti_id, mbti) values(7, 'ENHW');
insert into mbti(mbti_id, mbti) values(8, 'ENHD');
insert into mbti(mbti_id, mbti) values(9, 'ISOW');
insert into mbti(mbti_id, mbti) values(10, 'ISOD');
insert into mbti(mbti_id, mbti) values(11, 'ISHW');
insert into mbti(mbti_id, mbti) values(12, 'ISHD');
insert into mbti(mbti_id, mbti) values(13, 'INOW');
insert into mbti(mbti_id, mbti) values(14, 'INOD');
insert into mbti(mbti_id, mbti) values(15, 'INHW');
insert into mbti(mbti_id, mbti) values(16, 'INHD');
