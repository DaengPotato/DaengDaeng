...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .csrf().disable()
                .authorizeRequests() // 5
                .antMatchers("/", "/member/login/*","/place/recommend/dog","/place/recommend/member", "/member/nicknameCheck/*", "/swagger-resources/**", "/swagger-ui/**", "/v3/api-docs", "/swagger-ui/index.html").permitAll()
